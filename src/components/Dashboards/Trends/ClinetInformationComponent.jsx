...
export default function ClinetInformationComponent() {
    const accountData = [
        { no: "1234567890", openingDate: "21/01/2025", riskRating: "6.2/10", closingDate: "-", status: "Active", type: "Type 1", balance: "$65,000", interestRate: "2.5%" },
        { no: "9876543210", openingDate: "22/10/2024", riskRating: "8.1/10", closingDate: "-", status: "Active", type: "Type 3", balance: "$81,000", interestRate: "3.1%" },
        { no: "5647382910", openingDate: "14/08/2024", riskRating: "7.3/10", closingDate: "-", status: "Active", type: "Type 4", balance: "$95,500", interestRate: "2.9%" },
        { no: "1122334455", openingDate: "02/05/2023", riskRating: "8.5/10", closingDate: "12/08/2025", status: "Inactive", type: "Type 2", balance: "$1,000", interestRate: "1.2%" },
    ];
    ...
    return (
        <Box className={classes.container}>
            {/* Account Details */}
            <div role="region" aria-labelledby="account-details" className={classes.sectionCard}>
                <div id="account-details" className={classes.sectionHeader}>Account Details</div>
            ...
            <Grid container spacing={3} alignItems="stretch">
                <Grid item xs={12} sm={6} md={6} lg={6} xl={6} className={classes.stretch}>
                    <section className={classes.sectionCard}>
                        <header className={classes.sectionHeader}>Engagement Dates</header>
                ...
                <Grid item xs={12} sm={6} md={6} lg={6} xl={6} className={classes.stretch}>
                    <section className={classes.sectionCard}>
                        <header className={classes.sectionHeader}>Other ASB Teams Connected</header>
                        <div className={classes.sectionBody}>
                            {teamData.map((t, i) => (
